...
.definelabel Arm7RegisterFifoCallbackHook, 0x238A0D8 ; Actual address: 0x3801EF0
...
.open "arm7.bin", 0x02380000
	.org Arm7RegisterFifoCallbackHook
	.area 0x4
        .word 0b11101010101000101011101110001111 ; Branch to Arm7RegisterCallback
        ; Subsequent address: 0x3801EF4
	.endarea
.close
.open "arm9.bin", 0x02000000
    ...
    Arm7RegisterCallback:
        ...
        .word 0b11101010010111010100010001101000 ; Actual address: 0x20B0D4C, need to branch back to 0x3801EF4
	.endarea
.close
