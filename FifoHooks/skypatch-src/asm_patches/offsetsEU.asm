...
;                           single-bit flag
.definelabel PushFormattedMessageToFifoArm9, 0x207DEB8  ; r0 = event channel number (set to 0x12 for FifoHooks messages), r1 = 26-bit message, r2 = flag.

.definelabel Arm9RegisterFifoCallbackHook, 0x207D61C
.definelabel RegisterIpcEventTypeCallback_Arm9, 0x207DE48
...
.definelabel Arm9TemporaryHook, 0x22BD3C0 ; This hook will be overwritten by other code, but it will be used before that happens so it's ok.
...
.definelabel DSEEventsTable, 0x20B1294
